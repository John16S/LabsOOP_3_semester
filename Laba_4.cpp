...
/* Shablon class-Conteyner v vide Steka*/
template<class T>
class conteiner {
private:
	struct Stack {
...
public:
	...
	void Push(T& PO); // metod dobavleniye objecta v stek
